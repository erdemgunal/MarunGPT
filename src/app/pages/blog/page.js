...
export default function BlogPage() {
  ...
  const recentPosts = [
    { category: "Updates", title: "MarunGPT Updates: New Features Released", src: '/recent-posts.png', date: "May 15, 2023" },
    { title: "How to Make the Most of MarunGPT", category: "Tips & Tricks", src: '/recent-posts3.png', date: "May 10, 2023" },
    { title: "MarunGPT and Academic Integrity", category: "Ethics", src: '/recent-posts2.jpg', date: "May 5, 2023" },
    { title: "Faculty Perspectives on AI Assistants", category: "Perspectives", src: '/recent-posts4.png', date: "April 30, 2023" },
    { title: "MarunGPT: The Ultimate Study Buddy", category: "Study Tips", src: '/recent-posts5.png', date: "April 25, 2023" },
    { title: "AI in the Classroom: A Student's View", category: "Student Life", src: '/recent-posts6.png', date: "April 20, 2023" },
  ];
    ...
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      <div className="relative z-10 px-4 py-16 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeInUp}
          className="my-16 w-full h-full py-20"
        >
