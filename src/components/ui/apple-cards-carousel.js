...
export const Card = ({
  ...
  return (<>
    ...
    <motion.button
      layoutId={layout ? `card-${card.title}` : undefined}
      // onClick={handleOpen}
      className="cursor-pointer rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-56 md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10">
      <div
